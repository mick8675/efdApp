        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
            ...
            <body>
                <div id="content">
                    ...
                    <div id="welcome">
                        Welcome to Enterprise File Delivery <span class="build-version">2.2 (Java 8)</span> (<span class="build-date">Built on: October 10th, 2016</span>
			 <span class="build-number">#5</span>)
                    </div>
                    ...
                    <div id="cron" class="help">
                        ...
                        <table class="format">
                         ...
                         <ul>
                            ...
                            <li>The '?' character is allowed for the day-of-month and day-of-week fields. It is used to specify 'no specific value'. This is useful when you need to specify something in one of the two fields, but not the other.</li>
